...
def main() -> None:
    ...
    if menu == "📦 Ventes":
        ...
        try:
            ...
            depenses_argent_disponible = depenses_existantes[depenses_existantes['source_fonds'] == 'argent_disponible']['montant_mad'].sum() if not depenses_existantes.empty else 0.0
                        ...
                        if 'source_fonds' not in depenses.columns:
                            ...
                            if selected_depense_id:
                                ...
                                try:
                                    ...
                                    argent_disponible_modif = ca_total - cout_achats_ventes - depenses_argent_disponible - total_salaires
                                except Exception as e:
                                    st.error(f"Erreur calcul trésorerie: {e}")
